-- 初始化角色
INSERT INTO role (id, name, code, description, sort, enabled, create_time, update_time, deleted)
VALUES 
...
-- 初始化权限
INSERT INTO permission (id, name, code, type, parent_id, path, icon, component, sort, enabled, description, create_time, update_time, deleted)
VALUES 
-- 系统管理
...
-- 初始化角色权限关系
-- 管理员拥有所有权限
INSERT INTO role_permission (role_id, permission_id, create_time, update_time, deleted)
SELECT 1, id, NOW(), NOW(), 0 FROM permission WHERE deleted = 0;

-- 维修人员拥有工单管理权限
INSERT INTO role_permission (role_id, permission_id, create_time, update_time, deleted)
SELECT 2, id, NOW(), NOW(), 0 FROM permission WHERE code LIKE 'repair:%' AND deleted = 0;
...
-- 初始化知识库分类
INSERT INTO knowledge_category (id, name, code, parent_id, description, sort, icon, enabled, create_time, update_time, deleted)
VALUES 
